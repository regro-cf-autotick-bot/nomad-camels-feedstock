...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/nomad-camels-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/nomad-camels-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
      ...
      <details>
        ...
        <table>
          ...
          <tbody><tr>
              ...
              <td>
                <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=20830&branchName=main">
                  <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/nomad-camels-feedstock?branchName=main&jobName=osx&configuration=osx%20osx_64_python3.14.____cp314" alt="variant">
                </a>
              </td>
            </tr>
          </tbody>
...
pixi add nomad-camels
# for installing globally
pixi global install nomad-camels
```
...
It is possible to list all of the versions of `nomad-camels` available on your platform:
...
```
pixi search nomad-camels --channel conda-forge
```
